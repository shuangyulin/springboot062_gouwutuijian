...
import center from '@/views/center'
    ...
    import shangpinxiaoshoupaixingbang from '@/views/modules/shangpinxiaoshoupaixingbang/list'
...
const routes = [{
	...
	path: '/news',
      ...
      ,{
	path: '/shangpinxiaoshoupaixingbang',
        name: '商品销售排行榜',
        component: shangpinxiaoshoupaixingbang
      }
      ,{
	path: '/yonghu',
        name: '用户',
