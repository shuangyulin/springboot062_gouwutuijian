...
public class ShangpinxiaoshoupaixingbangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShangpinxiaoshoupaixingbangEntity() {
		
	}
	
	public ShangpinxiaoshoupaixingbangEntity(T t) {
		try {
